...
# # Download the dataset (this will download all files from the dataset)
# api.dataset_download_files('teamincribo/cyber-security-attacks')

# # Read the CSV file into a pandas DataFrame
# df = pd.read_csv('cyber-security-attacks.zip')
...
###Different preprocessing process for other team member ###
...
protocol_traffic_pivot = data.pivot_table(index="Traffic Type", columns="Protocol", aggfunc='count', values="Timestamp")
...
# Load the dataset and convert 'Timestamp' to datetime
df = pd.read_csv("cybersecurity_attacks.csv")
df['Timestamp'] = pd.to_datetime(df['Timestamp'])
